...
const rodeCurry = new Gerechten('Thaise rode curry',2,false,false,'vega',['Broccoli','Paprika','Wortel','2 el red curry paste','2 cups kokosmelk','2 spaanse pepers','2 cups basilicum','4 kaffir lime leaves','2 el vissaus','2 tl suiker'],'Somphong cooking guide')
const tomKhaKai = new Gerechten('Tom Kha Kai',2,false,false,'vega',['Broccoli','Paprika','Wortel','1 cup kokos melk','2 cups bouillon','16 slices galangal','10 slices lemongrass','4 karrif lime leaves'],'2 el lime juice','2 el vissaus','1 tl suiker','2 el koriander','Somphong cooking guide')
...
const risottoWorst = new Gerechten('Risotto met wortjes en rozemarijn',2,false,false,'vlees',['2 takjes rozemarijn','boter','1 ui','1 stengel bleekselderij','2 tenen knoflook','Gedroogde tijm','2 runder worsten','Risotto rijst','Rode wijn','Bouillon','Parmezaanse kaas'],'Italiaanse keuken pg. 76')
...
let _gerechten = [pastaPesto,beefBasil,jackFruit,couscous,nacho,fettuccine,kabeljauwMosterd,zalmGehakt,gelakteKip,zoeteAardappel,spinazieCurry,kabeljauwKomijnPaprika,ZalmGeitenkaas,visragout,aardbeiRisotto,rodeCurry,tomKhaKai,gebakkenRijst,tomatenSalade,gemberBeef,risottoWorst,broccoliRisotto,pappardelleRozenharissa,tomatenSoep,parelcouscousSalade]
