class Gerechten {
    ...
    get naam () {
        if (this._bijGerechtReq == false) {
            ...
            return `${this._name} uit ${this._source} met ${this._bijGerecht}`
        }
    }
    get bijGerecht () {
        let random = Math.floor(Math.random() * _bijGerechten.length)
        this._bijGerecht = _bijGerechten[random]
    }
}
...
let _bijGerechten = ['Zoete aardappel Cajun','Test 2', 'Test 3']
