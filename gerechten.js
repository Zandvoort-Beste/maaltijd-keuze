...
const visragout = new Gerechten('Visragout',4,true,false,'vis',['500g kabelfauwfilet','50g boter','60g bloem','viskruiden','1 visbouillion tablet','200g creme fraiche','peterselie','ragoutbakjes','bieslook'],'https://visrecepten.nl/recepten-bereiden/recepten/vol-au-vent-met-visragout')
...
const avocadoHollandaise = new Gerechten('Avocado Hollandaise',2,false,false,'vis',['350g asperges','2 witvis filet','2 lente uien','1 limoen','10g dragon','1 avocado','1 groot ei'],'7 ways pg 48')
const griekseSaladade = new Gerechten('Griekse Salade',4,false,false,'bijGerecht',['300g tomaten','1 rode ui','1 komkommer','1 groene paprika','Dille','Munt','Zwarte olijven','Rode wijn azijn','Extra virge olijf olie','200g feta','1 tl gedroogde oregano'],'https://www.jamieoliver.com/recipes/vegetables-recipes/greek-salad/')

let _gerechten = [griekseSaladade,avocadoHollandaise,pastaPesto,beefBasil,jackFruit,couscous,nacho,fettuccine,kabeljauwMosterd,zalmGehakt,gelakteKip,zoeteAardappel,spinazieCurry,kabeljauwKomijnPaprika,ZalmGeitenkaas,visragout,aardbeiRisotto,rodeCurry,tomKhaKai,rodeCurryVega,tomKhaKaiVega,gebakkenRijst,tomatenSalade,gemberBeef,risottoWorst,broccoliRisotto,tomatenSoep,parelcouscousSalade,gehaktBal,chickenPhal]
