...
const rodeCurryVega = new Gerechten('Thaise rode curry',2,false,false,'vega',['Broccoli','Paprika','Wortel','2 el red curry paste','2 cups kokosmelk','2 spaanse pepers','2 cups basilicum','4 kaffir lime leaves','2 el vissaus','2 tl suiker'],'Somphong cooking guide')
const tomKhaKaiVega = new Gerechten('Tom Kha Kai',2,false,false,'vega',['Broccoli','Paprika','Wortel','1 cup kokos melk','2 cups bouillon','16 slices galangal','10 slices lemongrass','4 karrif lime leaves'],'2 el lime juice','2 el vissaus','1 tl suiker','2 el koriander','Somphong cooking guide')
